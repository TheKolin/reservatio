	...
	<body>
		...
		<script>
			$(document).ready(function(){
				var currentRow, profile, semester, type, number, id;
				$("table").on('click','#edit_btn',function(){
					...
					profile = currentRow.find("td:eq(0)").text();
					semester= currentRow.find("td:eq(1)").text();
					type= currentRow.find("td:eq(2)").text();
					number = currentRow.find("td:eq(3)").text();
					//create input
					currentRow.find("td:eq(0)").html('<input class="form-control" type="text" name="new_profile" value="">');
					currentRow.find('input[name="new_profile"]').val(profile);
					
					currentRow.find("td:eq(1)").html('<input class="form-control" type="text" name="new_semester" value="">');
					currentRow.find('input[name="new_semester"]').val(semester);
					
					currentRow.find("td:eq(2)").html('<input class="form-control" type="text" name="new_type" value="">');
					currentRow.find('input[name="new_type"]').val(type);
					
					currentRow.find("td:eq(3)").html('<input class="form-control" type="text" name="new_number" value="">');
					currentRow.find('input[name="new_number"]').val(number);
				...
				//back to default
				function cancel(){
					currentRow.find("td:eq(0)").html(''+profile);
					currentRow.find("td:eq(1)").html(''+semester);
					currentRow.find("td:eq(2)").html(''+type);
					currentRow.find("td:eq(3)").html(''+number);
					currentRow.find("button:eq(1)").remove();
