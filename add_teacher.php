...
<html lang="pl">
	...
	<body>
		...
		<main>
			<div class="container">
				<p class="h2">Dodaj prowadzącego</p>
		...
		<script>
			$(document).ready(function(){
				...
				$("table").on('click','#edit_btn',function(){
					...
					first = currentRow.find("td:eq(0)").text();
					last = currentRow.find("td:eq(1)").text();
					//create input
					currentRow.find("td:eq(0)").html('<input class="form-control" type="text" name="new_first_name" value="">');
					currentRow.find('input[name="new_first_name"]').val(first);
					currentRow.find("td:eq(1)").html('<input class="form-control" type="text" name="new_last_name" value="">');
					currentRow.find('input[name="new_last_name"]').val(last);
					//edit to save
				...
				//back to default
				function cancel(){
					currentRow.find("td:eq(0)").html(''+first);
					currentRow.find("td:eq(1)").html(''+last);
					currentRow.find("button:eq(1)").remove();
